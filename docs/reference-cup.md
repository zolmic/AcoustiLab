...
| `missing_files_and_protocol_violations_are_reported` | a missing measurement, a lost seating, a wrong fixture, a coarse smoothing, a different drive and a missing sidecar are each reported, the bad files left out, the acceptance "not evaluated", and a stray file listed |
